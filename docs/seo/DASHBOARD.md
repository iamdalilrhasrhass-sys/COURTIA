...
| `/clients` | 10 | 0 | 0 | 0 |
| `/clients/208` | 9 | 0 | 0 | 0 |
| `/crm-courtier-assurance` | 8 | 1 | 0 | 0 |
| `/france/paris` | 8 | 1 | 0 | 0 |
...
| Pays | Clics | Impressions | Demandes de démo | Essais |
|---|---|---|---|---|
| Suisse | 9 | 36 | 0 | 0 |
| France | 5 | 129 | 0 | 0 |
| Canada | 1 | 8 | 0 | 0 |
| Etats-Unis | 0 | 42 | 0 | 0 |
| Republique democratique du Congo | 0 | 36 | 0 | 0 |
| Inde | 0 | 30 | 0 | 0 |

Les colonnes « demandes de démo » et « essais » sont à zéro : le funnel business par pays n’est pas mesurable aujourd’hui (aucun lead réel, aucune donnée d’attribution géographique côté site). Aucun taux de conversion par pays n’est donc calculé ni affirmé.

## 9. Définitions des métriques (à ne pas confondre)

| Indicateur | Définition |
|---|---|
| CTR SERP | clics / impressions (Search Console) |
| CTA Rate | clics CTA / sessions organiques mesurées |
| Demo Rate | demandes de démo / sessions organiques mesurées |
| Trial Rate | essais créés / sessions organiques mesurées |
| Activation Rate | essais activés / essais créés |
| Customer Rate | clients / sessions organiques mesurées |

Un CTR SERP élevé ne démontre aucune supériorité de conversion : ce sont deux indicateurs distincts.
