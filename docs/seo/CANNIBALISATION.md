...
- 0.75 : `/ch/import-portefeuille-courtier-assurance-suisse` <-> `/fr/import-portefeuille-courtier-assurance` (termes communs : changer, courtage, courtia, logiciel, portefeuille, reprendre)
