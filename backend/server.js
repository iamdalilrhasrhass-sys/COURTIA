...
const arkCoreRouter        = require('./src/routes/arkCore')
const arkWhatsappRouter    = require('./src/routes/arkWhatsapp')
const publicProspectsRouter = require('./src/routes/publicProspects')
...
app.use('/api/ark',             verifyToken, arkRateLimit, arkCoreRouter)
