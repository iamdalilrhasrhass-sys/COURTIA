...
// Configuration avec SSL strict MAIS rejectUnauthorized=false
const config = {
...
async function injectDatabase() {
  ...
  try {
    console.log('🔗 Connexion à la base de données avec SSL...');
    console.log('Host:', config.host);
    console.log('Database:', config.database);
    console.log('SSL rejectUnauthorized:', config.ssl.rejectUnauthorized);
