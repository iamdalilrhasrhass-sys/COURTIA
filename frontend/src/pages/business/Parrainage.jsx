  ...
  return React.createElement(motion.div, { initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, style: { padding: 24, maxWidth: 840 } },
    ...
    React.createElement("div", { style: { marginBottom: 32 } },
      React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 8 } },
        React.createElement("h1", { style: { fontSize: 28, fontWeight: 800, color: C.text, letterSpacing: "-0.5px" } }, "Programme Parrainage"),
      ...
      React.createElement("p", { style: { fontSize: 16, color: C.t2, lineHeight: 1.5 } }, "Transformez vos clients satisfaits en ambassadeurs rémunérés")
    ),
    React.createElement("div", { style: { ...cs, marginBottom: 24 } },
      React.createElement("div", { style: { display: "flex", alignItems: "flex-start", gap: 12 } },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", { style: { fontSize: 14, color: C.t2, lineHeight: 1.7 } }, "Offrez à vos clients un lien de parrainage unique. Quand un filleul souscrit, le parrain reçoit une récompense.")
        )
      )
    ),
    React.createElement("div", { style: { ...cs, marginBottom: 24 } },
      ...
      React.createElement("ol", { style: { paddingLeft: 0, listStyle: "none" } },
                    React.createElement("li", { key: 0, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "1."), "Activez le programme")
            React.createElement("li", { key: 1, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "2."), "Générez des liens de parrainage")
            React.createElement("li", { key: 2, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "3."), "Le client partage son lien")
            React.createElement("li", { key: 3, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "4."), "Un filleul souscrit")
            React.createElement("li", { key: 4, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "5."), "Le parrain reçoit sa récompense")
      )
    ),
    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 } },
      React.createElement("div", { style: { ...cs } },
        ...
        React.createElement("ul", { style: { paddingLeft: 0, listStyle: "none" } },             React.createElement("li", { key: 0, style: { marginBottom: 6, color: C.green, fontSize: 13 } }, "✓ Générateur de liens")
            React.createElement("li", { key: 1, style: { marginBottom: 6, color: C.green, fontSize: 13 } }, "✓ Tracking des filleuls")
            React.createElement("li", { key: 2, style: { marginBottom: 6, color: C.green, fontSize: 13 } }, "✓ Dashboard parrainage"))
      ),
      React.createElement("div", { style: { ...cs } },
        ...
        React.createElement("p", { style: { fontSize: 13, color: C.t2, lineHeight: 1.6 } }, "Le système de liens de parrainage et le tracking sont codés. L'intégration Stripe pour les récompenses est à finaliser.")
      )
    ),
    React.createElement("div", { style: { ...cs, borderColor: "rgba(139,92,246,0.2)", background: "rgba(139,92,246,0.04)" } },
      ...
      React.createElement("p", { style: { fontSize: 13, color: C.t2, lineHeight: 1.7, marginBottom: 12 } }, "Finaliser l'intégration Stripe Connect pour les versements de récompenses."),
    ...
    React.createElement("div", { style: { marginTop: 32, padding: "16px 20px", borderRadius: 12, background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.15)" } },
      React.createElement("p", { style: { fontSize: 14, color: "#6EE7B7", lineHeight: 1.6, margin: 0 } },
        React.createElement("strong", null, "💡 Bénéfice courtier :"), " Vos meilleurs commerciaux sont vos clients satisfaits. Un client parrainé a un taux de rétention 37 % supérieur."
      )
    )
  )
}
