...
const credibility = [
  { icon: Brain, label: 'COURTIARK s’occupe de tout' },
...
const workflow = [
  ...
  ['17h00', 'Portefeuille', 'COURTIARK gère le suivi, le courtier revient sur la croissance.'],
]
...
const pricing = [
  ...
  },
  {
    ...
    externalHref: 'mailto:contact@courtiark.fr?subject=COURTIARK%20Cabinet',
...
const reassurance = [
  ...
  ['Pas un CRM générique', 'COURTIARK vend du temps, du suivi et du potentiel commercial récupéré.', Radar],
  ['Accompagnement', 'Un outil métier doit être simple à comprendre, simple à adopter.', Mail],
]

const faq = [
  ['COURTIARK remplace-t-il mon logiciel actuel ?', 'COURTIARK devient le cockpit de suivi commercial du cabinet. Il peut compléter votre outil métier ou devenir le centre de pilotage clients, contrats, relances et portefeuille.'],
  ...
  ['Mes données sont-elles protégées ?', 'COURTIARK privilégie les accès protégés, la centralisation maîtrisée et une approche RGPD.'],
  ...
  ['COURTIARK convient-il à une équipe ?', 'Oui. Cabinet est prévu pour les cabinets structurés et les besoins avancés.'],
...
const landingCopy = {
  fr: {
    ...
    heroKicker: 'COURTIARK · gestion courtier pilotée par IA',
    heroTitle: 'COURTIARK s’occupe de tout. Le courtier développe son portefeuille.',
    heroBody: 'Plus besoin de porter la gestion, les relances, les appels, les dossiers et les échéances à la main. COURTIARK et ARK prennent en charge le quotidien opérationnel du cabinet. Vous gardez uniquement ce qui crée de la valeur: la relation client, le closing et le développement du portefeuille.',
    heroPrimary: 'Laisser COURTIARK gérer',
    ...
    conversion: ['0 € aujourd’hui', '7 jours d’essai', 'COURTIARK s’occupe de tout'],
    ...
    problemBody: 'Chaque appel reporté, chaque relance oubliée, chaque dossier incomplet et chaque contrat mal suivi attaque directement le chiffre. COURTIARK transforme ce bruit quotidien en actions commerciales prêtes à traiter.',
    arkKicker: 'ARK, assistant métier',
    arkTitle: 'COURTIARK s’occupe de tout: gestion, relances, appels, dossiers et échéances.',
    arkTiles: ['Tout est géré', 'Appels préparés', 'Relances gérées', 'Dossiers traités'],
    solutionKicker: 'Solution COURTIARK',
    solutionTitle: 'COURTIARK s’occupe de tout: gestion, relances, appels, dossiers et échéances.',
    solutionBody: 'Le courtier n’a plus à courir derrière les emails, les rappels, les pièces manquantes, les relances et les contrats à surveiller. COURTIARK organise, priorise et suit le quotidien du cabinet. Le courtier se concentre sur les rendez-vous, les clients et le développement du portefeuille.',
    ...
    pricingBody: 'Starter remet de l’ordre. Pro fait gagner du temps. Cabinet déploie la méthode sur l’équipe. La carte bancaire est gérée uniquement via Stripe Checkout sécurisé.',
    taxNote: 'Prix indiqués hors taxes. TVA applicable au taux en vigueur.',
    beforeAfter: [
      ['Avant COURTIARK', 'Le courtier subit: emails, relances à la main, dossiers qui traînent, échéances vues trop tard.'],
      ['Après COURTIARK', 'COURTIARK s’occupe de tout: gestion, relances, appels, dossiers, échéances. Le courtier vend et fidélise.'],
    ],
    finalTitle: 'Plus de gestion à subir. Plus de relances à porter. Plus de dossiers à courir.',
    finalBody: 'COURTIARK et ARK gèrent le quotidien opérationnel: suivi client, relances, appels, échéances, pièces manquantes et traitement des dossiers. Résultat: le cabinet tourne, les opportunités remontent, et le courtier peut enfin se concentrer sur le développement de son portefeuille.',
    closingTitle: 'COURTIARK gère le quotidien. Vous reprenez le commercial.',
    closingBody: 'Gestion, relances, appels, dossiers, échéances: COURTIARK s’occupe de tout ce qui ralentit le cabinet. Vous gardez la relation client, la décision et le développement du portefeuille.',
    ...
    cockpit: {
      title: 'Cockpit de suivi COURTIARK',
  ...
  en: {
    ...
    credibility: [
      { icon: Brain, label: 'COURTIARK handles the daily work' },
    ...
    workflow: [
      ...
      ['17:00', 'Portfolio', 'COURTIARK manages follow-up, the broker returns to growth.'],
    ],
    features: [
    ...
    reassurance: [
      ...
      ['Not a generic CRM', 'COURTIARK sells recovered time, follow-up discipline and commercial potential.', Radar],
      ['Guided adoption', 'A business tool must be simple to understand and simple to adopt.', Mail],
    ],
    faq: [
      ['Does COURTIARK replace my current software?', 'COURTIARK becomes the commercial follow-up cockpit. It can complement your business system or become the control center for clients, contracts, follow-ups and portfolio work.'],
      ...
      ['Is my data protected?', 'COURTIARK favors protected access, controlled centralization and a privacy-first approach.'],
      ...
      ['Does COURTIARK work for a team?', 'Yes. Cabinet is designed for structured agencies and advanced needs.'],
    ...
    heroKicker: 'COURTIARK · AI-powered broker operations',
    heroTitle: 'COURTIARK handles the work. Brokers grow the portfolio.',
    heroBody: 'No more carrying management, follow-ups, calls, files and deadlines by hand. COURTIARK and ARK run the agency’s daily operations. You keep only what creates value: client relationships, closing and portfolio growth.',
    heroPrimary: 'Let COURTIARK manage it',
    heroSecondary: 'See how ARK works',
    demo: 'Request a demo',
    conversion: ['0 today', '7-day trial', 'COURTIARK handles the work'],
    ...
    problemBody: 'Every postponed call, forgotten follow-up, incomplete file and badly tracked contract directly attacks revenue. COURTIARK turns that daily noise into ready-to-handle commercial actions.',
    arkKicker: 'ARK, business assistant',
    arkTitle: 'COURTIARK handles management, follow-ups, calls, files and renewals.',
    arkTiles: ['Everything handled', 'Calls prepared', 'Follow-ups managed', 'Files processed'],
    solutionKicker: 'COURTIARK solution',
    solutionTitle: 'COURTIARK handles management, follow-ups, calls, files and renewals.',
    solutionBody: 'Brokers no longer run behind emails, reminders, missing documents, follow-ups and contracts to watch. COURTIARK organizes, prioritizes and tracks the agency’s daily work. The broker focuses on meetings, clients and portfolio growth.',
    ...
    pricingBody: 'Starter brings order. Pro saves time. Cabinet rolls the method out to the team. Cards are handled only through secure Stripe Checkout.',
    taxNote: 'Prices shown excluding tax. Local tax may apply.',
    beforeAfter: [
      ['Before COURTIARK', 'The broker suffers: emails, manual follow-ups, files dragging, deadlines seen too late.'],
      ['After COURTIARK', 'COURTIARK handles management, follow-ups, calls, files and renewals. The broker sells and retains.'],
    ],
    finalTitle: 'No more management to endure. No more follow-ups to carry. No more files to chase.',
    finalBody: 'COURTIARK and ARK manage daily operations: client tracking, follow-ups, calls, renewals, missing documents and file processing. The agency runs, opportunities surface, and the broker can finally focus on growing the portfolio.',
    closingTitle: 'COURTIARK runs the daily work. You take back the commercial work.',
    closingBody: 'Management, follow-ups, calls, files, renewals: COURTIARK handles everything that slows the agency down. You keep client relationships, decisions and portfolio growth.',
    ...
    cockpit: {
      title: 'COURTIARK follow-up cockpit',
...
landingCopy.de = {
  ...
  heroKicker: 'COURTIARK · KI-gestützte Maklerorganisation',
  heroTitle: 'COURTIARK übernimmt den Alltag. Makler bauen ihr Portfolio aus.',
  heroBody: 'Verwaltung, Nachfassaktionen, Anrufe, Dossiers und Fristen müssen nicht mehr manuell getragen werden. COURTIARK und ARK übernehmen den operativen Alltag der Agentur. Sie behalten das, was Wert schafft: Kundenbeziehung, Abschluss und Wachstum.',
  heroPrimary: 'COURTIARK übernehmen lassen',
  heroSecondary: 'Sehen, wie ARK arbeitet',
  demo: 'Demo anfordern',
  conversion: ['0 heute', '7 Tage Test', 'COURTIARK übernimmt den Alltag'],
  ...
  closingTitle: 'COURTIARK führt den Alltag. Sie übernehmen wieder den Vertrieb.',
...
landingCopy.it = {
  ...
  heroKicker: 'COURTIARK · operazioni broker con IA',
  heroTitle: 'COURTIARK gestisce il quotidiano. Il broker sviluppa il portafoglio.',
  heroBody: 'Gestione, follow-up, chiamate, pratiche e scadenze non devono più essere portati a mano. COURTIARK e ARK prendono in carico l’operatività quotidiana dello studio. A voi resta ciò che crea valore: relazione cliente, closing e crescita del portafoglio.',
  heroPrimary: 'Lasciare gestire a COURTIARK',
  heroSecondary: 'Vedere come lavora ARK',
  demo: 'Richiedi una demo',
  conversion: ['0 oggi', '7 giorni di prova', 'COURTIARK gestisce il quotidiano'],
  ...
  closingTitle: 'COURTIARK gestisce il quotidiano. Voi riprendete il commerciale.',
  ...
  cockpit: {
    title: 'Cockpit follow-up COURTIARK',
...
function applyMarketCopy(baseCopy, market, locale) {
  ...
  const swissNavItems = {
    fr: [['story', 'Suisse'], ['ark', 'ARK'], ['cockpit', 'Cockpit'], ['pricing', 'Tarifs CHF']],
    en: [['story', 'Switzerland'], ['ark', 'ARK'], ['cockpit', 'Cockpit'], ['pricing', 'CHF pricing']],
    de: [['story', 'Schweiz'], ['ark', 'ARK'], ['cockpit', 'Cockpit'], ['pricing', 'CHF Preise']],
    it: [['story', 'Svizzera'], ['ark', 'ARK'], ['cockpit', 'Cockpit'], ['pricing', 'Prezzi CHF']],
  }
  const swissUiCopy = {
    fr: {
      ...
      chips: ['Gestion déléguée', 'Relances suivies', 'Suivi fiduciaire', 'Appels préparés'],
    ...
    en: {
      heroPrimary: 'Book a Swiss demo',
      heroSecondary: 'See CHF pricing',
      trial: 'Swiss demo',
      conversion: ['CHF from the start', 'LSA / FINMA framed', 'nLPD handled honestly'],
      chips: ['Management delegated', 'Follow-ups tracked', 'Fiduciary follow-up', 'Calls prepared'],
    ...
    de: {
      heroPrimary: 'Schweizer Demo buchen',
      heroSecondary: 'CHF Preise ansehen',
      trial: 'Schweizer Demo',
      conversion: ['CHF von Anfang an', 'LSA / FINMA sauber gerahmt', 'nLPD ehrlich behandelt'],
      chips: ['Verwaltung delegiert', 'Nachfassaktionen verfolgt', 'Treuhand-Follow-up', 'Anrufe vorbereitet'],
    ...
    it: {
      heroPrimary: 'Prenotare una demo svizzera',
      heroSecondary: 'Vedere i prezzi CHF',
      trial: 'Demo Svizzera',
      conversion: ['CHF fin dall’inizio', 'LSA / FINMA inquadrati', 'nLPD gestita con rigore'],
      chips: ['Gestione delegata', 'Follow-up tracciati', 'Follow-up fiduciario', 'Chiamate preparate'],
  ...
  const swissHeroCopy = {
    fr: {
      heroKicker: 'COURTIARK · gestion courtier et fiduciaire pilotée par IA',
      heroTitle: 'COURTIARK s’occupe de tout. Courtiers et fiduciaires développent leur portefeuille.',
      heroBody: 'Plus besoin de porter la gestion, les relances, les appels, les dossiers, les échéances et le suivi fiduciaire à la main. COURTIARK et ARK prennent en charge le quotidien opérationnel du cabinet. Vous gardez uniquement ce qui crée de la valeur: la relation client, le closing, le conseil et le développement du portefeuille.',
    },
    en: {
      heroKicker: 'COURTIARK · AI-powered broker and fiduciary operations',
      heroTitle: 'COURTIARK handles the work. Brokers and fiduciaries grow the portfolio.',
      heroBody: 'No more carrying management, follow-ups, calls, files, deadlines and fiduciary follow-up by hand. COURTIARK and ARK run the agency’s daily operations. You keep only what creates value: client relationships, closing, advisory work and portfolio growth.',
    },
    de: {
      heroKicker: 'COURTIARK · KI-gestützte Makler- und Treuhandorganisation',
      heroTitle: 'COURTIARK übernimmt den Alltag. Makler und Treuhänder bauen ihr Portfolio aus.',
      heroBody: 'Verwaltung, Nachfassaktionen, Anrufe, Dossiers, Fristen und Treuhand-Follow-up müssen nicht mehr manuell getragen werden. COURTIARK und ARK übernehmen den operativen Alltag der Kanzlei. Sie behalten das, was Wert schafft: Kundenbeziehung, Abschluss, Beratung und Wachstum.',
    },
    it: {
      heroKicker: 'COURTIARK · operatività broker e fiduciaria con IA',
      heroTitle: 'COURTIARK gestisce il quotidiano. Broker e fiduciari sviluppano il portafoglio.',
      heroBody: 'Gestione, follow-up, chiamate, pratiche, scadenze e follow-up fiduciario non devono più essere gestiti a mano. COURTIARK e ARK prendono in carico l’operatività quotidiana dello studio. A voi resta ciò che crea valore: relazione cliente, closing, consulenza e crescita del portafoglio.',
    },
  }
  const marketHero = swissHeroCopy[locale] || swissHeroCopy.fr
  return {
    ...baseCopy,
    navItems: swissNavItems[locale] || swissNavItems.fr,
    heroKicker: marketHero.heroKicker,
    heroTitle: marketHero.heroTitle,
    heroBody: marketHero.heroBody,
    heroPrimary: marketUi.heroPrimary,
    heroPrimaryHref: '/demo?market=CH',
    heroSecondary: marketUi.heroSecondary,
    trial: marketUi.trial,
    trialHref: '/demo?market=CH',
    languageLabel,
    conversion: marketUi.conversion,
    chips: marketUi.chips,
    pricing: swissPricing,
    pricingKicker: marketUi.pricingKicker,
    pricingTitle: marketUi.pricingTitle,
    pricingBody: marketUi.pricingBody,
    taxNote: marketUi.taxNote,
    features: [
    ...
    footerPricing: marketUi.footerPricing,
    footerContact: marketUi.footerContact,
  }
}
...
export default function LandingPublic() {
  ...
  useEffect(() => {
    applySeo({
      title: 'COURTIARK — Le cockpit IA des courtiers d’assurance',
      description:
        'COURTIARK centralise clients, contrats, relances et conformité des courtiers d’assurance, en France (DDA · ORIAS · RGPD) comme en Suisse (LSA · FINMA · nLPD).',
      canonicalPath: '/',
      robots: 'index, follow',
      alternates:
        locale === 'fr'
    ...
    <div className="courtia-landing min-h-screen overflow-x-hidden text-white">
      ...
      <nav className={`fixed inset-x-0 top-0 z-50 transition duration-300 ${scrolled ? 'border-b border-white/[0.06] bg-[#02040c]/86 shadow-xl shadow-black/20 backdrop-blur-2xl' : 'bg-transparent'}`}>
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5">
          <Link to="/" aria-label="COURTIARK" className="flex items-center gap-3">
