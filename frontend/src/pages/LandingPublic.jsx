...
const modules = [
  { name: 'Clients', detail: 'Historique complet', status: '3 actions', icon: Users, color: '#8fe7ff', x: '0%', y: '8%', z: 40 },
  { name: 'Contrats', detail: 'Échéance J-30', status: 'alerte', icon: ShieldCheck, color: '#a986ff', x: '72%', y: '6%', z: 40 },
  { name: 'DDA', detail: 'Compte rendu prêt', status: 'export', icon: ClipboardCheck, color: '#d8f4ff', x: '-15%', y: '44%', z: 70 },
  { name: 'Relances', detail: 'Client non relancé', status: 'priorité', icon: Target, color: '#ff65bb', x: '85%', y: '40%', z: 70 },
  { name: 'ARK', detail: 'Priorités du jour', status: 'live', icon: Sparkles, color: '#f8a8d8', x: '35%', y: '86%', z: 100 },
]
...
.scene-orbit.orbit-a{inset:-18%;border:1px solid rgba(143,231,255,.07);box-shadow:0 0 30px rgba(143,231,255,.01)}
