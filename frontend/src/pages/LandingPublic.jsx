...
const modules = [
  { name: 'Clients', detail: 'Historique complet', status: '3 actions', icon: Users, color: '#8fe7ff', x: '-2%', y: '4%', z: 50 },
  { name: 'Contrats', detail: 'Échéance J-30', status: 'alerte', icon: ShieldCheck, color: '#a986ff', x: '74%', y: '2%', z: 50 },
  { name: 'DDA', detail: 'Compte rendu prêt', status: 'export', icon: ClipboardCheck, color: '#d8f4ff', x: '-18%', y: '38%', z: 70 },
  { name: 'Relances', detail: 'Client non relancé', status: 'priorité', icon: Target, color: '#ff65bb', x: '88%', y: '34%', z: 70 },
  { name: 'ARK', detail: 'Priorités du jour', status: 'live', icon: Sparkles, color: '#f8a8d8', x: '68%', y: '70%', z: 90 },
]
