...
const modules = [
  { name: 'Clients', detail: 'Historique complet', status: '3 actions', icon: Users, color: '#8fe7ff', x: '4%', y: '16%', z: 60 },
  { name: 'Contrats', detail: 'Échéance J-30', status: 'alerte', icon: ShieldCheck, color: '#a986ff', x: '68%', y: '14%', z: 60 },
  { name: 'DDA', detail: 'Compte rendu prêt', status: 'export', icon: ClipboardCheck, color: '#d8f4ff', x: '-1%', y: '46%', z: 80 },
  { name: 'Relances', detail: 'Client non relancé', status: 'priorité', icon: Target, color: '#ff65bb', x: '74%', y: '44%', z: 80 },
  { name: 'ARK', detail: 'Priorités du jour', status: 'live', icon: Sparkles, color: '#f8a8d8', x: '36%', y: '78%', z: 100 },
]
