...
const faq = [
  ...
  ['COURTIA convient-il à une équipe ?', 'Oui. Cabinet est prévu pour les cabinets structurés et les besoins avancés.'],
...
const landingCopy = {
  ...
  en: {
    ...
    faq: [
      ...
      ['Does COURTIA work for a team?', 'Yes. Cabinet is designed for structured agencies and advanced needs.'],
...
function applyMarketCopy(baseCopy, market, locale) {
  ...
  const swissHeroCopy = {
    ...
    en: {
      heroKicker: 'COURTIA · AI-powered broker and fiduciary operations',
      heroTitle: 'COURTIA handles the work. Brokers and fiduciaries grow the portfolio.',
      heroBody: 'No more carrying management, follow-ups, calls, files, deadlines and fiduciary follow-up by hand. COURTIA and ARK run the agency’s daily operations. You keep only what creates value: client relationships, closing, advisory work and portfolio growth.',
    },
    de: {
      heroKicker: 'COURTIA · KI-gestützte Makler- und Treuhandorganisation',
      heroTitle: 'COURTIA übernimmt den Alltag. Makler und Treuhänder bauen ihr Portfolio aus.',
      heroBody: 'Verwaltung, Nachfassaktionen, Anrufe, Dossiers, Fristen und Treuhand-Follow-up müssen nicht mehr manuell getragen werden. COURTIA und ARK übernehmen den operativen Alltag der Kanzlei. Sie behalten das, was Wert schafft: Kundenbeziehung, Abschluss, Beratung und Wachstum.',
    },
    it: {
      heroKicker: 'COURTIA · operatività broker e fiduciaria con IA',
      heroTitle: 'COURTIA gestisce il quotidiano. Broker e fiduciari sviluppano il portafoglio.',
      heroBody: 'Gestione, follow-up, chiamate, pratiche, scadenze e follow-up fiduciario non devono più essere gestiti a mano. COURTIA e ARK prendono in carico l’operatività quotidiana dello studio. A voi resta ciò che crea valore: relazione cliente, closing, consulenza e crescita del portafoglio.',
    },
  }
