...
export default function Login() {
  ...
  function handleGoogleLogin() {
    setError(GOOGLE_CLIENT_ID
      ? 'Connexion Google temporairement indisponible. Utilisez la connexion email et mot de passe.'
      : 'Connexion Google non configurée. Utilisez la connexion email et mot de passe.'
    )
  }
