  ...
  return React.createElement(motion.div, { initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, style: { padding: 24, maxWidth: 840 } },
    ...
    React.createElement("div", { style: { marginBottom: 32 } },
      React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 12, marginBottom: 8 } },
        React.createElement("h1", { style: { fontSize: 28, fontWeight: 800, color: C.text, letterSpacing: "-0.5px" } }, "Portail Client"),
      ...
      React.createElement("p", { style: { fontSize: 16, color: C.t2, lineHeight: 1.5 } }, "Offrez à vos clients un espace personnel sécurisé 24h/24")
    ),
    React.createElement("div", { style: { ...cs, marginBottom: 24 } },
      React.createElement("div", { style: { display: "flex", alignItems: "flex-start", gap: 12 } },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", { style: { fontSize: 14, color: C.t2, lineHeight: 1.7 } }, "Chaque client dispose d'un portail sécurisé pour consulter ses contrats et déposer des documents.")
        )
      )
    ),
    React.createElement("div", { style: { ...cs, marginBottom: 24 } },
      ...
      React.createElement("ol", { style: { paddingLeft: 0, listStyle: "none" } },
                    React.createElement("li", { key: 0, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "1."), "Invitation par email")
            React.createElement("li", { key: 1, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "2."), "Création du mot de passe")
            React.createElement("li", { key: 2, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "3."), "Vue des contrats et documents")
            React.createElement("li", { key: 3, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "4."), "Demande de RDV ou sinistre")
            React.createElement("li", { key: 4, style: { marginBottom: 10, color: C.t2, fontSize: 14, lineHeight: 1.6 } }, React.createElement("span", { style: { color: C.text, fontWeight: 600, marginRight: 8 } }, "5."), "Notifications cockpit")
      )
    ),
    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 } },
      React.createElement("div", { style: { ...cs } },
        ...
        React.createElement("ul", { style: { paddingLeft: 0, listStyle: "none" } },             React.createElement("li", { key: 0, style: { marginBottom: 6, color: C.green, fontSize: 13 } }, "✓ Architecture PWA")
            React.createElement("li", { key: 1, style: { marginBottom: 6, color: C.green, fontSize: 13 } }, "✓ Token de session client")
            React.createElement("li", { key: 2, style: { marginBottom: 6, color: C.green, fontSize: 13 } }, "✓ Upload de documents"))
      ),
      React.createElement("div", { style: { ...cs } },
        ...
        React.createElement("p", { style: { fontSize: 13, color: C.t2, lineHeight: 1.6 } }, "L'architecture du portail est en place. L'interface client est à finaliser.")
      )
    ),
    React.createElement("div", { style: { ...cs, borderColor: "rgba(139,92,246,0.2)", background: "rgba(139,92,246,0.04)" } },
      ...
      React.createElement("p", { style: { fontSize: 13, color: C.t2, lineHeight: 1.7, marginBottom: 12 } }, "Créer l'interface client mobile-first, connecter les endpoints de données client."),
    ...
    React.createElement("div", { style: { marginTop: 32, padding: "16px 20px", borderRadius: 12, background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.15)" } },
      React.createElement("p", { style: { fontSize: 14, color: "#6EE7B7", lineHeight: 1.6, margin: 0 } },
        React.createElement("strong", null, "💡 Bénéfice courtier :"), " Vos clients sont autonomes et satisfaits. Moins d'appels, plus de temps pour votre cœur de métier."
      )
    )
  )
}
