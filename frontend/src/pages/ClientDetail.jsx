...
function BubbleTooltip({ type, client, scores, onMouseEnter, onMouseLeave }) {
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none flex items-center justify-center p-4">
      <motion.div initial={{ scale: 0.9, opacity: 0, y: 20 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.9, opacity: 0, y: 20 }} transition={{ duration: 0.2, ease: 'easeOut' }} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} style={{ pointerEvents: 'auto', background: 'rgba(255,255,255,0.25)', backdropFilter: 'blur(24px) saturate(200%)', border: '2px solid rgba(147,51,234,0.3)', boxShadow: '0 0 60px rgba(59,130,246,0.4), inset 0 0 30px rgba(147,51,234,0.1)', borderRadius: '40% 60% 50% 50% / 50% 50% 60% 40%', animation: 'bubbleFloat 6s ease-in-out infinite' }} className="relative w-full max-w-sm p-6 text-slate-900">
